...
const VehicleCard = ({ vehicleNumber, deviceUid, createdDate }) => {
  return (
    <div className="font-pretendard flex w-full max-w-lg flex-col gap-1 rounded-xl bg-cornflower-100 p-6 text-center shadow-sm ">
