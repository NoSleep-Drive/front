...
const columns = [
  ...
  },
  {
    ...
    label: '다운로드',
    render: () => (
      <div className="hover:bg-cornflower-300 inline-flex h-full cursor-pointer items-center justify-center rounded-4xl p-2 transition">
        <Download className="text-cornflower-950" size={18} />
      </div>
    ),
  },
];
